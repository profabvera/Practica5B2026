...
Escriba un programa que solicite al usuario dos números enteros y muestre su suma. La novedad aquí es que deberá usar el objeto **cin** junto con el operador **>>** de inserción en el flujo de entrada. Ambos objetos de la librería **iostream**. La salida del programa desde el terminal debe verse así. 
